...
const конструкторМассивов = () => {
  const массивы = {};
  return (массив) => {
    let возвращаемыйМассив = [];
    if (Array.isArray(массив)) {
      возвращаемыйМассив = массив;
    } else {
      возвращаемыйМассив = Ы.получить(массивы, массив, возвращаемыйМассив);
    }
    const объектМассива = {
      данные: возвращаемыйМассив,
      преобразовать: (функцияПреобразования) => {
        return возвращаемыйМассив.map(функцияПреобразования);
      },
      создать: (значения) => {
        массивы[массив] = значения;
        return {
          ...объектМассива,
          данные: массивы[массив],
        };
      }
    };
    return объектМассива;
  }
}

Ы.массив = конструкторМассивов();
